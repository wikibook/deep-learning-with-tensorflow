...
if __name__ == '__main__':
    ...
    output_digits = digits + 1  # 5000+5000 = 10000 이상이면 5자리가 된다
    ...
    while len(questions) < N:
        a, b = n(digits), n(digits)  # 두 개의 수를 적당히 생성한다
        ...
        question = '{}+{}'.format(a, b)
        question = padding(question, input_digits)  # 부족한 자릿수를 채운다
        answer = str(a + b)
        answer = padding(answer, output_digits)  # 부족한 자릿수를 채운다
